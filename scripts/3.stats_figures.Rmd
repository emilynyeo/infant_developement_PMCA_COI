...
#load("~/projects/research/ADOR/CHLA_clean//clean_inputs/meta_bay_april11.RData")
...
desc_labels <- c("Sex","Gestational Age","Race and/or Ethnicity","Child Opp Index",
                 "Cognitive Bayleys Score",
                 "Motor Bayleys Score",
                 "Language Bayleys Score",
                 "PMCA Category",
                 "Age at first Bayleys",
...
ggplot(no_pmca_na, aes(x = PMCA_birth, y = Composite_Score, fill = Which_Bayleys)) +
  ...
  scale_fill_manual(values = c("#809bce", "#B2D3C2", "#7ec4cf", "#a6cee3", 
                    ...
                    name = "Bayleys Developmental Domain") +
  labs(x = "PMCA categorization", y = "Bayleys Composite Score") +
...
ggplot(no_pmca_na, aes(x = Composite_Score, y = Which_Bayleys)) +
  ...
  labs(x = "Bayleys Composite Score", y = "Bayleys Developemental Domain") +
  theme(axis.title.x = element_text(margin = margin(t = 20), 
                                    hjust = 0.5,
                                    size = 13),  
        axis.title.y = element_text(margin = margin(r = 20), 
...
cog_emmeans$PMCA_birth <- factor(cog_emmeans$PMCA_birth, 
                                  levels = c("Non-chronic", "Non-complex Chronic", "Complex Chronic")) # Order
...
cog_plot <- create_plot(cog_emmeans, "Cognitive Bayley's Score", "Cognitive Score by PMCA")
motor_plot <- create_plot(motor_emmeans, "Motor Bayley's Score", "Motor Score by PMCA")
lang_plot <- create_plot(lang_emmeans, "Language Bayley's Score", "Language Score by PMCA")
...
compiled %>%
  ...
  facet_grid(bay_mode~.) +
  coord_flip() +
  labs(x = "Bayleys Domain", y = "Log-odds Coefficient Estimate", 
       color = "PMCA Category",
       title = "Log-odds Coefficient of Having a Bayleys Score in the Lowest Decile") +
  theme_minimal() +
...
desc_labels <- c("Sex","Gestational Age", "Gestational Age Category",
                 "Race and/or Ethnicity","Child Opp Index",
                 "Cognitive Bayleys Score",
                 "Motor Bayleys Score",
                 "Language Bayleys Score",
                 "PMCA Category",
